...
SessionTrack::SessionTrack(const QVector<QProcess *> &processes)
  ...
  connect(SignalHandler::self(), &SignalHandler::signalReceived,
...
void SessionTrack::removeProcess(int exitCode, QProcess::ExitStatus exitStatus) {

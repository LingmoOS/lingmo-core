...
public:
   ...
   * @param parent
   */
  explicit Daemon(const QList<std::tuple<QString, QStringList,QProcessEnvironment>> &processList,
...
private:
   ...
   * @param processInfo
   */
  void startProcess(const std::tuple<QString, QStringList,QProcessEnvironment> &processInfo);

  QList<std::tuple<QString, QStringList, QProcessEnvironment>> m_processList;
